...
<template>
              ...
              <div class="relative flex size-full min-h-screen flex-col bg-amber-200 group/design-root overflow-x-hidden" style='font-family: "Work Sans", "Noto Sans", sans-serif;'>
      <div class="layout-container flex h-full grow flex-col">
        ...
        <form @submit.prevent="login">
          <div class="layout-content-container flex flex-col w-[512px]  py-5 max-w-[960px] flex-1">
            <h1 class="text-[#0d131b] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 text-left pb-3 pt-5">Добро пожаловать</h1>
            <p class="text-[#0d131b] text-base font-normal leading-normal pb-3 pt-1 px-4">Зарегистрируйтесь в Grooming DP и получите доступ к своему кабинету</p>
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#0d131b] text-base font-medium leading-normal pb-2">Почта</p>
                <input type="email"
                  placeholder="Почта"
            ...
            <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
              <label class="flex flex-col min-w-40 flex-1">
                <p class="text-[#0d131b] text-base font-medium leading-normal pb-2">Пароль</p>
                <input type="password"
                  placeholder="Пароль"
                  class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#0d131b] focus:outline-0 focus:ring-0 border border-[#cfd8e7] bg-[#f8f9fc] focus:border-[#cfd8e7] h-14 placeholder:text-[#4c6a9a] p-[15px] text-base font-normal leading-normal"
                  v-model="password"
            ...
            <p class="text-amber-800 text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center underline">Входя в систему, вы соглашаетесь с условиями использования и политикой конфиденциальности Grooming DP.</p>
            <p class="text-amber-800 text-sm font-normal leading-normal pb-3 pt-1 px-4 text-center">Нет аккаунта? Зарегистрируйтесь</p>
          </div>
        </form>
      </div>
    </div>
